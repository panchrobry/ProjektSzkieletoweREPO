...
urlpatterns = [
    ...
    url(r'^addraceLegoLF/$',views.createRaceLF, name = 'createRaceLegoLF'),
    url(r'^addraceLF/$',views.createRaceLegoLF, name = 'createRaceLF'),
    ...
    url(r'^groupManual/$',views.ManualGroup, name = 'ManualGroup'),
